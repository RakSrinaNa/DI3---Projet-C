...
void metaheuristicGeneticTests()
{
	...
	solution_destroy(metaheuristicGenetic_search(instance, DIRECT, 10, 0.5, 5, 0, 0));
	printf("~");
	solution_destroy(metaheuristicGenetic_search(instance, DIRECT, 10, 0.5, 5, 0, 1));
	printf("~");
	solution_destroy(metaheuristicGenetic_search(instance, INDIRECT, 10, 0.5, 5, 0, 0));
	printf("~");
	solution_destroy(metaheuristicGenetic_search(instance, INDIRECT, 10, 0.5, 5, 0, 1));
	printf("~");
	solution_destroy(metaheuristicGenetic_search(instance, DIRECT, 10, 0.5, 5, 1, 0));
	printf("~");
	solution_destroy(metaheuristicGenetic_search(instance, DIRECT, 10, 0.5, 5, 1, 1));
	printf("~");
	solution_destroy(metaheuristicGenetic_search(instance, INDIRECT, 10, 0.5, 5, 1, 0));
	printf("~");
	solution_destroy(metaheuristicGenetic_search(instance, INDIRECT, 10, 0.5, 5, 1, 1));
	printf("~");
	solution_destroy(metaheuristicGenetic_search(instance, DIRECT, 10, 0.5, 5, 2, 0));
	printf("~");
	solution_destroy(metaheuristicGenetic_search(instance, DIRECT, 10, 0.5, 5, 2, 1));
	printf("~");
	solution_destroy(metaheuristicGenetic_search(instance, INDIRECT, 10, 0.5, 5, 2, 0));
	printf("~");
	solution_destroy(metaheuristicGenetic_search(instance, INDIRECT, 10, 0.5, 5, 2, 1));
	printf("~");
	instance_destroy(instance);
