...
\begin{itemize}
	...
	\item \item MetaheuristicKaguyaTemp $\longrightarrow$ Regroupant les fonctions liées à notre metaheuristique personalisée (contenant les structures Clan, ClanMember et DNA) en phase de reconception.
\end{itemize}
...
\begin{itemize}
	...
	\item metaheuristicGenetic\_selectParentsFight $\longrightarrow$ %TODO
	\item metaheuristicGenetic\_selectParentsRoulette $\longrightarrow$ %TODO
	\item metaheuristicGenetic\_breedChildren $\longrightarrow$ Créé deux enfants à partir de deux parents.
	\item metaheuristicGenetic\_breedChildrenPMX $\longrightarrow$ %TODO
	\item metaheuristicGenetic\_breedChildren1Point $\longrightarrow$ %TODO
	\item metaheuristicGenetic\_mutation $\longrightarrow$ Permet de faire muter une solution.
	\item metaheuristicGenetic\_naturalSelection $\longrightarrow$ %TODO
	\item metaheuristicGenetic\_naturalSelectionGeneration $\longrightarrow$ %TODO
	\item metaheuristicGenetic\_naturalSelectionElitist $\longrightarrow$ %TODO
	\item metaheuristicGenetic\_naturalSelectionBalanced $\longrightarrow$ %TODO
\end{itemize}
...
\begin{itemize}
	\item clanMember\_ancestor $\longrightarrow$ %TODO
	\item clanMember\_destroy $\longrightarrow$ Permet de détruire un membre.
	\item clanMember\_generation $\longrightarrow$ %TODO
	...
	\item clanMember\_evaluate $\longrightarrow$ %TODO
...
Les fonctions lui étant associées sont:\begin{itemize}
	...
	\item clan\_generation $\longrightarrow$ %TODO
	\item clan\_dispertion $\longrightarrow$ %TODO
	\item clan\_extinction $\longrightarrow$ %TODO
	\\
\end{itemize}
...
Ce projet fut une bonne expérience et très intéressant. Le problème en lui même est assez concret et permet de se familiariser avec celui-ci rapidement.

Nous avons eu un départ assez rapide et avons trouvé une heuristique qui avait d'assez bon résultats. Cependant nous avons ralenti sur la fin ce qui nous a empêché de faire tourner l'algorithme sur de vrai données afin d'interpréter les résultats. De plus la metaheuristique inventée est probablement à revoir car elle explore beaucoup trop de résultats et prend par conséquent un temps important.
